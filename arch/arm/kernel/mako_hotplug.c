...
online_all:
	pr_info("mako_hotplug: reviving cpu");
	cpus_online_work();
...
static void __ref decide_hotplug_func(struct work_struct *work)
{
	...
	schedule_delayed_work_on(0, &decide_hotplug,
...
reschedule:
	...
	schedule_delayed_work_on(0, &decide_hotplug, HZ * 2);
}
...
static int __devinit mako_hotplug_probe(struct platform_device *pdev)
{
	...
	schedule_delayed_work_on(0, &decide_hotplug, HZ * 30);
